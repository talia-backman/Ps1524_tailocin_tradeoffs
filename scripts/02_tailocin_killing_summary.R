...
#
# Inputs:
#   - data/input/tailocin_killing_long.csv
...
# paths
in_killing <- "./data/input/tailocin_killing_long.csv"
in_hap     <- "./data/input/HTF_length_haplotype.csv"
out_pdf    <- "./figures/tailocin_killing_summary.pdf"
out_txt    <- "./data/output/tailocin_killing_summary_stats.txt"

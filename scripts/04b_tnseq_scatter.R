...
#
# Input:
#   - data/output/tnseq_merged.csv # output because it came from script 04a
#
# Outputs:
#   - figures/tnseq_scatter.pdf
#   - data/output/tnseq_manuscript_table.csv
#
# Dependencies:
...
# read in TnSeq data
dat <- read.csv("./data/output/tnseq_merged.csv")
...
p3
# save
ggsave("./figures/tnseq_scatter.pdf", p3, width = 8, height = 4, dpi = 300)
...
# load in data
df <- read_csv("./data/output/tnseq_merged.csv", show_col_types = FALSE)
...
# write csv
write_csv(df, "./data/output/tnseq_manuscript_table.csv")

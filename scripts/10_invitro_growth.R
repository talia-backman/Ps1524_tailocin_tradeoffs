...
#
# Inputs:
#   data/input/invitro_growth_synthesis.csv
#     Required columns:
#       - TIME          (numeric, hours)
...
#
# Outputs:
#   figures/invitro_growthcurves.pdf
#   data/output/invitro_growthcurveR_data.csv
#   data/output/invitro_growthcurve_stats.csv
#
# Dependencies:
...
dSynthesis <- read.csv("./data/input/invitro_growth_synthesis.csv")
...
ggsave("./figures/invitro_growthcurves.pdf", SMABS, width = 10, height = 6, dpi = 300)
...
write.csv(Abs_export, "./data/output/invitro_growthcurveR_data.csv", row.names = FALSE)
...
write.csv(Abs_fits_results, "./data/output/invitro_growthcurve_stats.csv", row.names = FALSE)

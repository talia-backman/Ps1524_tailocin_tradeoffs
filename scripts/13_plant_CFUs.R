...
#
# Input:
#   - data/13_plant_CFUs/input/Synthesis_CFU.csv
#
# Outputs:
...
#   - data/13_plant_CFUs/output/13_WT_vs_wfgD_stats.csv
#
# Notes:
...
data <- read.csv("./data/13_plant_CFUs/input/Synthesis_CFU.csv")
...
ggsave("./figures/13_Eyach_2dpi.pdf", p1, width = 6, height = 6)
ggsave("./figures/13_Eyach_5dpi.pdf", p2, width = 6, height = 6)
ggsave("./figures/13_Col0_2dpi.pdf",  p3, width = 6, height = 6)
ggsave("./figures/13_Col0_5dpi.pdf",  p4, width = 6, height = 6)
...
write.csv(res_all, "./data/13_plant_CFUs/output/13_WT_vs_wfgD_stats.csv", row.names = FALSE)

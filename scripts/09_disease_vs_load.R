...
#
# Input:
#   - data/input/plant_disease.csv
#   - data/input/plant_infections_contam.csv
#   - data/input/plant_infections_layout.csv
#   - data/input/plant_infections_luciferase_7dpi.csv
#
# Output:
#   - figures/disease_vs_load.pdf
#   - data/output/disease_vs_load_per_ecotype_linear_models.csv
#
# Dependencies:
...
dat <- read.csv("./data/input/plant_disease.csv")
...
contam <- read.csv("./data/input/plant_infections_contam.csv")
...
layout_plate <- read.csv("./data/input/plant_infections_layout.csv", header = TRUE)
...
lux_dat <- read.csv("./data/input/plant_infections_luciferase_7dpi.csv")
...
p
# save plot
ggsave("./figures/disease_vs_load.pdf", p, width = 8, height = 6)

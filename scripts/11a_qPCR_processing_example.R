...
#Title: qPCR analysis - qPCR_20250825_Col-0_FRK1_WRKY29_1
...
#Import dataset
rfu_data <- read_csv("./data/11_qPCR/input/11a_RFUs.csv", show_col_types = FALSE) %>%
...
plate_map <- read_csv("./data/11_qPCR/input/11a_Template.csv", show_col_types = FALSE)
...
write_csv(well_summary,"./data/11_qPCR/output/11a_Cq_Eff.csv")
...
view(techrep_check_all)

write_csv(techrep_check_all,"./data/11_qPCR/output/11a_checks.csv")
...
view(well_summary_clean)

write_csv(well_summary_clean,"./data/11_qPCR/output/11a_Cq_Eff_cleanup.csv")
...
write_csv(ne_time0, "./data/11_qPCR/output/11a_NE_Time0.csv")
write_csv(ne_mock, "./data/11_qPCR/output/11a_NE_Mock.csv")
write_csv(mne_summary_time0, "./data/11_qPCR/output/11a_MNE_summary_Time0.csv")
write_csv(mne_summary_mock, "./data/11_qPCR/output/11a_MNE_summary_Mock.csv")
...
save_path <- "./figures/11a_plots_mne_time0_treatment.pdf"
...
save_path <- "./figures/11a_plots_mne_mock_timepoint.pdf"
pdf(save_path, width = 12, height = 8)

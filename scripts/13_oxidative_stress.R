...
#   data/input/
#     - ROS_OD600_R12.csv ... OD600_R16.csv
#     - ROS_layout_R12.csv ... layout_R16.csv
#
# Outputs:
#   figures/ROS.pdf
#   data/output/ROS_WT_MIC_by_replicate.csv
#   data/output/ROS_emmeans_contrasts_vsWT_scaledMIC.csv
#
# Dependencies:
...
long_all <- map_dfr(rep_ids, function(r) {
  layout_path <- file.path(input_dir, paste0("ROS_layout_", r, ".csv"))
  od_path     <- file.path(input_dir, paste0("ROS_OD600_", r, ".csv"))
...
# save MICs 
write_csv(wt_mic, file.path(out_dir, "ROS_WT_MIC_by_replicate.csv"))
...
write_csv(mic_table, file.path(out_dir, "ROS_MIC_table.csv"))
...
write_csv(contr_out, file.path(out_dir, "ROS_emmeans_contrasts_vsWT_scaledMIC.csv"))
...
ggsave(file.path(out_fig, "ROS.pdf"), p, width = 9, height = 6, dpi = 300)
